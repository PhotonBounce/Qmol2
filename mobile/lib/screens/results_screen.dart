      ...
      body: _results.isEmpty
          ...
          : SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: [
                  DataColumn(label: const Text('SMILES'), onSort: (_, __) => _sort('smiles')),
                  DataColumn(label: const Text('MW'), numeric: true, onSort: (_, __) => _sort('mw')),
                  DataColumn(label: const Text('logP'), numeric: true, onSort: (_, __) => _sort('logP')),
                  DataColumn(label: const Text('QED'), numeric: true, onSort: (_, __) => _sort('qed')),
